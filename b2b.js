...
const displayCharacters = (accounts) => {
    ...
    .map((account) => {
            ...
            <button type="button" class="accountBtn" id="trackbtn"><img class="track-icon " src="resources/spinner.png">Track</button>
            </li>`;
        ...
        for(let i=0;i<Accountbtn.length;i++){
            Accountbtn[i].addEventListener('mousedown',()=>{
                Accountbtn[i].innerText="Tracking";
                Accountbtn[i].style.color='#1AAB2B';
                Accountbtn[i].style.borderColor='#1AAB2B';
                console.log(accountAttributes[i].company);
                console.log(accountAttributes[i].slug);
        ...
        for(let i=0;i<Accountbtn.length;i++){
            Accountbtn[i].addEventListener('mouseout',()=>{
        ...
        //     for(let i=0;i<Accountbtn.length;i++){
        //         trackIcon[i].classList.remove("hidden");
        //     }
        // });
